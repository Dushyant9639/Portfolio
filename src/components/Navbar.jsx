...
>
  ...
  <div>
    <h1 className="text-lg font-semibold text-white tracking-wide">Dushyant Goyal</h1>
    <p className="text-xs text-gray-300 tracking-wide">Full Stack Developer</p>
  </div>
</motion.div>
      ...
      {open && (
        ...
        >
          ...
          <a href="#skills" className="block py-2 text-gray-200">Skills</a>
          <a href="#projects" className="block py-2 text-gray-200">Projects</a>
